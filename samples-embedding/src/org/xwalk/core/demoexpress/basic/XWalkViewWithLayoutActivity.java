...
public class XWalkViewWithLayoutActivity extends XWalkActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xwalk_view_with_layout);
    }
    ...
    protected void onXWalkReady() {
        ...
        textDes.setText("This sample demonstrates the basic functions of XWalkView, including navigation, pausing timers and scaling the view.");
